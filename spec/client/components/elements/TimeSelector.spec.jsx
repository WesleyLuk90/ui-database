...
describe('TimeSelector', () => {
    ...
    it('should call the callback', () => {
        ...
        selector.setProps({ hour: 3, minute: 0 });
        ...
        selector.setProps({ hour: 3, minute: 15 });
        expect(selector.find('.hours').prop('value')).toBe('3');
